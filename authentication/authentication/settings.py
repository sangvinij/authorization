...
# find and load environmental variables
...
SECRET_KEY = 'django-insecure-t2)xw0o+6wz*m&hkcc=veezfd*sy9@tq#=w10hn60w!#b7g)%('
...
AUTH_USER_MODEL = 'accounts.User'  # модель пользователя, которая будет использоваться
...
"""настройки для пересылки писем на электронную почту"""
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
